...
const SvgRestaurantSmall = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#restaurant-small_svg__a)">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
    ...
    <defs>
      <clipPath id="restaurant-small_svg__a">
...
export default SvgRestaurantSmall;
