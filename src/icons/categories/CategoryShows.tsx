...
const SvgCategoryShows = (props: SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#Category-Shows_svg__a)" fill="currentColor">
    ...
    <defs>
      <clipPath id="Category-Shows_svg__a">
...
export default SvgCategoryShows;
