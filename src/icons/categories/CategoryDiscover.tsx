...
const SvgCategoryDiscover = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#Category-Discover_svg__a)" fill="currentColor">
    ...
    <defs>
      <clipPath id="Category-Discover_svg__a">
...
export default SvgCategoryDiscover;
