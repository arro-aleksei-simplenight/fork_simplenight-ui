...
const SvgCategoryThings = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#Category-Things_svg__a)">
      <path
    ...
    <defs>
      <clipPath id="Category-Things_svg__a">
...
export default SvgCategoryThings;
