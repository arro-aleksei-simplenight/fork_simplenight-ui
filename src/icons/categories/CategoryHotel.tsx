...
const SvgCategoryHotel = (props: SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#Category-Hotel_svg__a)">
      <path
    ...
    <defs>
      <clipPath id="Category-Hotel_svg__a">
...
export default SvgCategoryHotel;
