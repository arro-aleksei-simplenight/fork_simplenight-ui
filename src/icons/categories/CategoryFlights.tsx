...
const SvgCategoryFlights = (props: SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#Category-Flights_svg__a)">
      <g clipPath="url(#Category-Flights_svg__b)">
        <path
    ...
    <defs>
      <clipPath id="Category-Flights_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
      <clipPath id="Category-Flights_svg__b">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
...
export default SvgCategoryFlights;
