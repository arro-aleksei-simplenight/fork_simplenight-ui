...
const SvgCasinoSmall = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#casino-small_svg__a)" fill="#0DADB9">
    ...
    <defs>
      <clipPath id="casino-small_svg__a">
