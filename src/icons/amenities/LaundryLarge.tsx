...
const SvgLaundryLarge = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={49}
    height={48}
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#laundry-large_svg__a)">
      <g clipPath="url(#laundry-large_svg__b)">
        <path
    ...
    <defs>
      <clipPath id="laundry-large_svg__a">
        <path fill="#fff" transform="translate(.5)" d="M0 0h48v48H0z" />
      </clipPath>
      <clipPath id="laundry-large_svg__b">
        <path fill="#fff" transform="translate(.5)" d="M0 0h48v48H0z" />
      </clipPath>
    </defs>
  </svg>
...
export default SvgLaundryLarge;
